 ...
 *
 * A write-only stream is used when writing data to a
 * _destination_. For example, writing to a console's ("stdout")
 * or ("stderr") stream or when creating HTTP requests, on
 * the client.
 *
